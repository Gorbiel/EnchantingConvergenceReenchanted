...
public class CapabilityUnlockedEnchantmentLevelsProvider
        extends BasicCapabilityProviderSerializable<CapabilityUnlockedEnchantmentLevels> {
    ...
    public Tag serializeNBT() {
        ...
        for (Object2IntMap.Entry<ResourceLocation> entry :
                this.getInstance().getUnlockedEnchantmentLevels().object2IntEntrySet()) {
