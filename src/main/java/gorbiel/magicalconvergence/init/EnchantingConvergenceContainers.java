...
public class EnchantingConvergenceContainers {
	...
	public static final RegistryObject<MenuType<ContainerEnchantingConvergence>> ENCHANTING_TABLE =
			CONTAINERS.register("enchanting_table",
					() -> new MenuType<>(ContainerEnchantingConvergence::new, FeatureFlags.DEFAULT_FLAGS));
