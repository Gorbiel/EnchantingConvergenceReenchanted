...
public class EnchantingConvergenceConfig {
    ...
    public static class ServerConfig {
        ...
        // TODO add missing comments, ranges and maybe some blank lines separating entries
        public ServerConfig(ForgeConfigSpec.Builder builder) {
            this.checkIfItemHasEnchantability = builder.define("checkIfItemHasEnchantability", false);
            this.checkIfEnchantmentIsTreasureEnchantment =
                    builder.define("checkIfEnchantmentIsTreasureEnchantment", true);
            ...
            this.expEnchantmentRarityModifier =
                    builder.defineInRange("expEnchantmentRarityModifier", 8.0D, 0.0D, 256.0D);
            this.expItemEnchantabilityModifier =
                    builder.defineInRange("expItemEnchantabilityModifier", 50.0D, 0.0D, 256.0D);
            ...
            this.lapisEnchantmentRarityModifier =
                    builder.defineInRange("lapisEnchantmentRarityModifier", 8.0D, 0.0D, 256.0D);
            this.lapisItemEnchantabilityModifier =
                    builder.defineInRange("lapisItemEnchantabilityModifier", 50.0D, 0.0D, 256.0D);

            this.unlockEnchantmentModeEnabled = builder.comment("When enabled enchantments first have to be unlocked.")
                    .define("unlockEnchantmentModeEnabled", true);
            this.unlockEnchantmentModeHardcore = builder.comment(
                            "When enabled when unlocking a new random enchantment it may unlock an enchantment of a lower tier.")
                    .define("unlockEnchantmentModeHardcore", false);

            this.unlockEnchantmentModeCommonWeight =
                    builder.defineInRange("unlockEnchantmentModeCommonWeight", 4, 1, 100);
            this.unlockEnchantmentModeUncommonWeight =
                    builder.defineInRange("unlockEnchantmentModeUncommonWeight", 3, 1, 100);
            this.unlockEnchantmentModeRareWeight = builder.defineInRange("unlockEnchantmentModeRareWeight", 2, 1, 100);
            this.unlockEnchantmentModeVeryRareWeight =
                    builder.defineInRange("unlockEnchantmentModeVeryRareWeight", 1, 1, 100);
        }
    }
}
